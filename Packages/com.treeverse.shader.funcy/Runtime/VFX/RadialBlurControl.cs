...
public class RadialBlurControl : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        radiusblurSettings = TreeverseUniversalRenderFeature.GetRadiusBlurSettings();
        TreeverseUniversalRenderFeature.radialBlurControls.Add(this);
        if (playOnAwake)
        {
            Play();
        }
    ...
    {
        TreeverseUniversalRenderFeature.radialBlurControls.Remove(this);
    }
}
