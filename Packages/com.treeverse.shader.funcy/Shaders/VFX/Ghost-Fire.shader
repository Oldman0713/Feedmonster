...
Shader "Treeverse/VFX/Ghost Fire"
{
	Properties
	{
		...
		[Toggle]_ClipUseCustomData("Clip Use CustomData", Float) = 0
		[ASEEnd][Toggle]_RefractionZUseCustomData("Refraction Z Use CustomData", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Speed;
			float _Clip;
			float _ClipUseCustomData;
			float _EdgeBlur;
			float _RefractionZUseCustomData;
			float _CullOfBottom;
			float _Soft;
			CBUFFER_END
			TEXTURE2D(_MainTex);
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float smoothstepResult243 = smoothstep( _RefractionRange.x , _RefractionRange.y , max( SAMPLE_TEXTURE2D_LOD( _MainTex, sampler_MainTex, frac( panner236 ), 0.0 ).b , SAMPLE_TEXTURE2D_LOD( _MainTex, sampler_MainTex, frac( panner237 ), 0.0 ).b ));
			 ...
			 ) : SV_Target
			{
				...
				float lerpResult375 = lerp( _Clip , IN.ase_texcoord3.zw.x , _ClipUseCustomData);
				float2 break323 = baseUV319;
				float mulTime239 = _TimeParameters.x * _Speed;
				float2 panner236 = ( mulTime239 * float2( 0,-0.9913 ) + baseUV319);
				float2 panner237 = ( mulTime239 * float2( 0.217,-0.799641 ) + baseUV319);
				float smoothstepResult243 = smoothstep( _RefractionRange.x , _RefractionRange.y , max( SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, frac( panner236 ) ).b , SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, frac( panner237 ) ).b ));
				float temp_output_253_0 = ( smoothstepResult243 * _RefractionIntensity );
				float temp_output_256_0 = saturate( ( ( break323.y - min( 0.4 , _RefractionIntensity ) ) + temp_output_253_0 ) );
				float lerpResult377 = lerp( _RefractionRange.z , IN.ase_texcoord3.zw.y , _RefractionZUseCustomData);
				float2 appendResult246 = (float2(break323.x , ( temp_output_256_0 + lerpResult377 )));
				float2 fireUV248 = appendResult246;
				float4 tex2DNode247 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, ( ( fireUV248 * _MainTex_ST.xy ) + _MainTex_ST.zw ) );
				...
				float smoothstepResult270 = smoothstep( ( lerpResult375 - _EdgeBlur ) , ( lerpResult375 + _EdgeBlur ) , temp_output_311_0);
				...
				clip( temp_output_311_0 - lerpResult375);
				...
				float3 Color = appendResult356;
				float Alpha = ( temp_output_311_0 * smoothstepResult270 * (lerpResult290).a * saturate( distanceDepth350 ) );
...
/*ASEBEGIN
Version=18935
2552;320;2048;1089.4;-3054.606;1450.297;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;238;1536,-256;Inherit;False;Property;_Speed;Speed;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;231;1536,-1024;Inherit;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;0;False;0;False;None;65a8c5e7454b8fe45a5edf74bf690048;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;252;2688,128;Inherit;False;Property;_RefractionIntensity;Refraction Intensity;5;0;Create;True;0;0;0;False;0;False;0.438;0.441;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;263;2304,128;Inherit;False;Property;_RefractionRange;Refraction Range;9;0;Create;True;0;0;0;False;0;False;0.17,0.79,0,0;0.1,0.79,-0.07,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;376;2304,384;Inherit;False;Property;_RefractionZUseCustomData;Refraction Z Use CustomData;13;1;[Toggle];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;373;640,-512;Inherit;False;1;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;377;2627.041,226.9346;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;306;2304,-496;Inherit;False;Property;_CullOfBottom;Cull Of Bottom;10;0;Create;True;0;0;0;False;0;False;0.263;0.416;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;2496.4,-823.2999;Inherit;False;Property;_Clip;Clip;6;0;Create;True;0;0;0;False;0;False;0.15;0.065;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;374;2365.309,-924.0227;Inherit;False;Property;_ClipUseCustomData;Clip Use CustomData;12;1;[Toggle];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;273;2816,-768;Inherit;False;Property;_EdgeBlur;EdgeBlur;7;0;Create;True;0;0;0;False;0;False;0.05;0.2;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;375;2915.309,-995.0227;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;269;3584,-2304;Inherit;False;Property;_ColorUp;ColorUp;0;1;[HDR];Create;True;0;0;0;False;0;False;0.8156863,0,8,1;0,0.1426557,4.541205,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;294;3584,-2048;Inherit;False;Property;_ColorDown;ColorDown;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0.5337852,1.071773,1;2.648764,1.117166,2.774895,0.5803922;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;289;3712,-1520;Inherit;False;Property;_ColorCenter;ColorCenter;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0.1782091,0.5188679,1;0.9012759,0,5.216475,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;355;3957.314,-1322.432;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;352;3933.037,-427.6794;Inherit;False;Property;_Soft;Soft;11;0;Create;True;0;0;0;False;0;False;0.5;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;296;3840,-768;Inherit;False;Property;_VertexIntensity;Vertex Intensity;8;0;Create;True;0;0;0;False;0;False;0;0.706;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;335;2688,-1152;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;361;4745.9,-1136.635;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;21;Treeverse/VFX/Ghost Fire;689d3e8c4ac0d7c40a3407d6ee9e04bc;True;Forward;0;3;Forward;12;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;1;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;18;Surface;1;638021838049356450;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;638021838083663249;  Use Shadow Threshold;0;0;Receive Shadows;0;638021838095548886;GPU Instancing;1;0;LOD CrossFade;0;0;Treeverse Linear Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Full Screen Pass;0;0;Additional Pass;0;0;Scene Selectioin Pass;0;0;Vertex Position,InvertActionOnDeselection;1;638021838513850847;Discard Fragment;0;0;Push SelfShadow to Main Light;0;0;2;MRT Output;0;0;Custom Output Position;0;0;8;False;False;False;True;False;False;False;False;False;;True;0
...
WireConnection;377;0;263;3
WireConnection;377;1;373;2
WireConnection;377;2;376;0
WireConnection;256;0;245;0
WireConnection;359;0;256;0
WireConnection;359;1;377;0
...
WireConnection;271;0;375;0
WireConnection;271;1;273;0
WireConnection;272;0;375;0
...
WireConnection;361;2;356;0
WireConnection;361;3;313;0
WireConnection;361;5;298;0
ASEEND*/
//CHKSM=5535A177E880F97F149B1D882E5DAA2B8998EB38