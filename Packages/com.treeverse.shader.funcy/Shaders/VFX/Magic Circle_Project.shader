...
Shader "Treeverse/VFX/Magic Circle-Project"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][HDR]_Color("Color", Color) = (1,0.5701252,0.1839623,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_MagicArrowMap);
			SAMPLER(sampler_MagicArrowMap);
			TEXTURE2D(_MainTex);
			...
			VertexOutput vert(VertexInput v)
			{
				...
				float4 w2oR0 = w2o._11_12_13_14;
				float4 w2oR1 = w2o._21_22_23_24;
				float4 w2oR2 = w2o._31_32_33_34;
				float4 w2oR3 = w2o._41_42_43_44;
			...
			half4 frag(VertexOutput IN ): SV_Target
			{
				...
				half temp_output_452_0 = min( SAMPLE_TEXTURE2D( _NoiseMap, sampler_NoiseMap, ( ( panner369 * _NoiseMap_ST.xy ) + _NoiseMap_ST.zw ) ).r , SAMPLE_TEXTURE2D( _NoiseMap, sampler_NoiseMap, ( ( panner447 * _NoiseMap_ST.xy ) + _NoiseMap_ST.zw ) ).r );
				...
				half temp_output_437_0 = max( max( ( ( 1.0 - smoothstepResult391 ) * SAMPLE_TEXTURE2D( _MagicArrowMap, sampler_MagicArrowMap, rotator380 ).a ) , ( SAMPLE_TEXTURE2D( _MagicArrowMap, sampler_MagicArrowMap, rotator390 ).a * smoothstepResult403 ) ) , ( 1.0 - smoothstepResult418 ) );
				...
				half4 tex2DNode427 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, rotator421 );
				...
				float Alpha = ( max( ( tex2DNode427.r * tex2DNode427.a * min( smoothstepResult425 , lerpResult426 ) ) , ( temp_output_437_0 * smoothstepResult425 ) ) * 2.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 currentUV358 = IN.ase_texcoord2.xy;
				half mulTime407 = _TimeParameters.x * 0.1;
				float cos421 = cos( ( mulTime407 * PI ) );
				float sin421 = sin( ( mulTime407 * PI ) );
				half2 rotator421 = mul( currentUV358 - float2( 0.5,0.5 ) , float2x2( cos421 , -sin421 , sin421 , cos421 )) + float2( 0.5,0.5 );
...
/*ASEBEGIN
Version=18935
348;210;1920;1059;-1012.932;1756.412;1.338628;True;False
Node;AmplifyShaderEditor.RangedFloatNode;353;-1037.324,84.5531;Inherit;False;Property;_Angle;Angle;6;0;Create;True;0;0;0;False;0;False;186.0151;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;362;112,240;Inherit;True;Property;_NoiseMap;NoiseMap;5;0;Create;True;0;0;0;False;0;False;6a1fffff897d00e459ab3c9226cbedc6;6a1fffff897d00e459ab3c9226cbedc6;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;361;-213.0236,254.8372;Inherit;False;Property;_Blur;Blur;8;0;Create;True;0;0;0;False;0;False;0.05;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;446;752,437;Inherit;True;Property;_TextureSample4;Texture Sample 4;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;433;514.7602,1159.993;Inherit;False;Property;_CenterSplit;Center Split;7;0;Create;True;0;0;0;False;0;False;0.5411765;0.739;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;399;98.67639,-1595.447;Inherit;True;Property;_MagicArrowMap;Magic Arrow Map;3;0;Create;True;0;0;0;False;0;False;594858368701aa048886de204e28d1ae;594858368701aa048886de204e28d1ae;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;401;434.6764,-1163.447;Inherit;True;Property;_TextureSample2;Texture Sample 2;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;402;444.5013,-1359.097;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;423;818.6764,-2219.447;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;0;False;0;False;None;638c901fa2480184caefaa43d9024bae;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;439;2114.835,-8.989868;Inherit;False;Property;_EdgeColor;EdgeColor;4;1;[HDR];Create;True;0;0;0;False;0;False;1,0.1142083,0,1;0.3301887,0,0.2156677,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;441;2111.929,-224.7733;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;0;False;0;False;1,0.5701252,0.1839623,1;0.5599657,0,0.2096192,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;435;2369.299,-1712.909;Inherit;False;Property;_MagicArrowColor1;Color;2;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;7.046587,0.4985792,1.938456,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;456;2432,-880;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;454;3301.959,-1557.917;Half;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;17;Treeverse/VFX/Magic Circle-Project;d9a07a90db7fc20418f0da16c269dae8;True;Forward;0;0;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;1;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;4;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;6;  Blend;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;For Particle System;0;0;0;2;True;True;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;455;3301.959,-1557.917;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;d9a07a90db7fc20418f0da16c269dae8;True;SceneSelectionPass;0;1;SceneSelectionPass;1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;1;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;454;2;445;0
WireConnection;454;3;456;0
ASEEND*/
//CHKSM=891E389396120CC70AE2A4EF2B2F85DFE9D2E4E3