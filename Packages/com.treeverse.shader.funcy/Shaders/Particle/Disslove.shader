...
Shader "Treeverse/Particle/Disslove"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			 ...
			 ) : SV_Target
			{
				...
				float2 uvMain_tex = IN.ase_texcoord3.xy * Main_tex_ST.xy + Main_tex_ST.zw;
				float4 tex2DNode6 = SAMPLE_TEXTURE2D( Main_tex, samplerMain_tex, ( IN.ase_texcoord3.xy + (( SAMPLE_TEXTURE2D( Main_tex, samplerMain_tex, uvMain_tex ).b * IN.ase_texcoord4.z )).xx ) );
				...
				float eyeDepth37 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float Alpha = ( temp_output_25_0 * IN.ase_color.a * _Color.a * saturate( ( ( eyeDepth37 - eyeDepth ) / IN.ase_texcoord4.w ) ) );
...
/*ASEBEGIN
Version=18935
2560;307;2048;1100.6;1870.651;43.07074;1;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;5;-1664,-256;Inherit;True;Property;Main_tex;BaseMap;0;0;Create;False;0;0;0;False;0;False;None;ce65e84ec609f4745918705129cb45f5;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;8;-1024,-128;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ScreenDepthNode;37;-640,512;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SurfaceDepthNode;33;-640,640;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;36;-384,512;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;27;256,-640;Inherit;False;Property;_Color;Color;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;2,2,2,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;24;256,0;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;38;-256,512;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;34;-128,512;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=FCE94032562B4516A94AB4A0A72DE3C0754CAFC6