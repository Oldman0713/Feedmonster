...
namespace UnityEditor.Polybrush
{
    abstract class ConfigurableWindow : EditorWindow, IHasCustomMenu
    {
        ...
        public static T GetWindow<T>(string title, bool focus = true) where T : ConfigurableWindow
        {
        ...
        /// </summary>
        public static T GetWindow<T>(bool utility, string title, bool focus) where T : ConfigurableWindow
        {
