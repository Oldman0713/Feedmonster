            ...
            list.Add(new DebugUI.Container
            {
                ...
                children =
                {
                    ...
                    new DebugUI.Button
                    {
                        ...
                        action = () =>
                        {
                            if (!enableLogging) { Debug.Log("You must first enable logging before this logging frame information."); } logFrameInformation = true;
            #if UNITY_EDITOR
                    ...
                    new DebugUI.Button
                    {
                        ...
                        action = () =>
                        {
                            if (!enableLogging) { Debug.Log("You must first enable logging before this logging resources."); } logResources = true;
            #if UNITY_EDITOR
                            UnityEditor.SceneView.RepaintAll();
            #endif
                        }
